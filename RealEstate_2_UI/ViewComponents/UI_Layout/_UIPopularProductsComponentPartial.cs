...
{
    public class _UIPopularProductsComponentPartial:ViewComponent
    {
        private readonly IHttpClientFactory _httpClientFactory;

        public _UIPopularProductsComponentPartial(IHttpClientFactory httpClientFactory)
        {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            var responseMess = await client.GetAsync("https://localhost:44387/api/Product/ProductwithCategory");
